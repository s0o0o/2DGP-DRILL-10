...
class Idle:
    ...
    def draw(boy):
        if boy.face_dir == 1:
            boy.image.clip_composite_draw(int(boy.frame) * 183, boy.action * 338, 183, 169,
                                          0, '', boy.x - 25, boy.y - 25, 183 / 2, 169 / 2)
        else:
            boy.image.clip_composite_draw(int(boy.frame) * 183, boy.action * 338, 183, 169,
                                          0, 'h', boy.x - 25, boy.y - 25, 183 / 2, 169 / 2)
...
class BIRD:
    ...
    def draw(self):
        ...
        if self.dir == 1:
            self.image.clip_composite_draw(int(self.frame) * 183, 338, 183, 169,
                                      0, '', self.x - 25, self.y - 25, 183/2, 169/2)
        if self.dir == -1:
            self.image.clip_composite_draw(int(self.frame) * 183, 338, 183, 169,
                                      0, 'h', self.x - 25, self.y - 25, 183/2, 169/2)
